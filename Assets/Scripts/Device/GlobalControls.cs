...
public class GlobalControls : MonoBehaviour {
    ...
    public static int    SaveVersion      = 2;          // Format version of save.gd. Bump this whenever GameState's fields change, so old saves are rejected with a readable message instead of a deserialization error
